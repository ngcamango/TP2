 ...
 * @author ngcamango
 */
public class TestOCPViolation extends TestCase {
    private Registration re;
    
    public TestOCPViolation(String testName) {
        super(testName);
    }
    ...
    protected void setUp() throws Exception {
        ...
        re = (Registration)ctx.getBean("ocpViolation");
    }
